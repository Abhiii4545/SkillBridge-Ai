                                   ...
                                   <div className="flex items-center gap-3">
                                        <div className="relative group/select">
                                            <select
                                                ...
                                                className={`appearance-none pl-3 pr-8 py-1.5 rounded-full text-xs font-bold border outline-none cursor-pointer transition-all ${
                                                    applicant.status === 'Accepted' ? 'bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-400 border-green-200 dark:border-green-800' :
                          ...
                          <div className="flex-1">
                              ...
                              <div className="flex flex-wrap gap-4 text-blue-100 text-sm font-medium">
                                  ...
                                  <div className={`flex items-center gap-1.5 px-3 py-1 rounded-full border ${
                                      selectedCandidate.status === 'Accepted' ? 'bg-green-500/20 border-green-400 text-white' : 
