    ...
    <div className="bg-white dark:bg-[#0a0a16] rounded-[2rem] border border-slate-200 dark:border-white/5 shadow-sm hover:shadow-lg hover:border-blue-200 dark:hover:border-blue-500/30 transition-all duration-300 overflow-hidden group">
      <div className="p-6">
        <div className="flex justify-between items-start">
          ...
          <div className={`flex flex-col items-end px-3 py-1.5 rounded-xl border ${scoreColor((internship as any).dynamicMatchScore || internship.matchScore || 0)}`}>
            <span className="text-xl font-bold">{(internship as any).dynamicMatchScore || internship.matchScore || 0}%</span>
            <span className="text-[10px] font-bold uppercase tracking-wide opacity-80">{scoreLabel((internship as any).dynamicMatchScore || internship.matchScore || 0)}</span>
          </div>
        </div>
        ...
        <div className="px-6 pb-6 bg-slate-50/50 dark:bg-white/[0.02] border-t border-slate-100 dark:border-white/5 animate-fade-in">
          ...
          <div className="mt-8">
            <button
              ...
              disabled={hasApplied}
              className={`w-full py-3.5 rounded-xl font-bold transition-all flex items-center justify-center gap-2 ${hasApplied
